...
@section('content')
    <div class="relative pt-14 md:pt-28 lg:pt-48">
        ...
        <div  id="contact-form"  class="container w-95% py-16 px-2 lg:p-24 bg-grey-light z-40 mb-20 md:mb-28 lg:mb-36">
            ...
            {{-- FORM --}}
            <form id="contactForm" method="POST" action="/send-email" class="mt-24">
                @csrf
                {{-- ERROR --}}
                {{-- @if ($errors->any())
        ...
        <div class="contact-card container flex bg-contact-details-pattern bg-cover bg-center text-white bg-no-repeat">
            <div class="contact-card-details flex-1 flex flex-col justify-center items-center h-56 z-10">
