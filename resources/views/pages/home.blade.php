...
@section('content')
    ...
    <div class="banner flex relative justify-center items-center">
        ...
        <div class="text-center text-white banner-text absolute w-full h-full left-0 top-0 flex justify-center items-center">
            <div class="flex flex-col justify-center items-center">
                ...
                <div><i class="mt-8 fas fa-arrow-down fa-2x icon icon-light"></i></div>
            </div>
        </div>
    ...
    {{-- Description --}}
    <div class="description px-2 py-28 md:px-3 md:py-32 text-center md:text-left">
        <div class="container flex flex-wrap justify-content items-center">
            <div class="md:w-4/6 md:pr-20 mb-10 md:mb-0">
                <h1 class="heading heading-line-left heading-medium text-black-DEFAULT">Samoan Proud</h1>
    ...
    {{-- Services --}}
    <div class="overflow-hidden services px-2 py-28 md:px-3 md:py-32 bg-grey-DEFAULT relative">
        ...
        <div class="container">
            <div class="text-center mb-20">
                ...
                <h1 class="heading heading-line-center heading-medium text-black-DEFAULT">Baked With Love</h1>
                ...
                @foreach ($services as $service)
                    <div class="services-card p-3 md:bg-transparent md:p-0 flex-col md:flex-row">
                        ...
                        <div class="services-card-info md:text-left flex justify-center items-center md:items-start flex-col pb-4 md:pb-0">
                            <h2 class="text-2xl lg:text-3xl text-black-DEFAULT">{{ucfirst($service->service)}}</h2>
